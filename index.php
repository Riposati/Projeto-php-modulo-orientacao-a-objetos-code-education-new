...
<div id='tudo'>
    <div id='mostra-nomes-todos-clientes'>
        ...
        <form>
            ...
            <button onclick="return ordemCrescente(this,'<?= $baseDados[0]["nome"] ?>')" value=''
                    class='btn btn-success'>
                Mostrar ordem crescente
            </button>

            <button onclick="return ordemDecrescente(this,'<?= $baseDados[0]["nome"] ?>')" id='nomes-clientes'
            ...
            $j = (sizeof($baseDados)) - 1; // mostrar em ordem decrescente
